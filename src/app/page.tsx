...
export default function LandingPage() {
  ...
  <div id="products" data-section="products">
      ...
      useInvertedBackground={true}
      products={[
        { id: "p1", name: "Memory Fuel", price: "", variant: "Top Seller", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CtJvMn9momZmpQncydBEDXlj8M/uploaded-1777876141937-p5z8u7iu.png", onProductClick: () => window.open('https://memoryfuel.example.com', '_blank') },
        { id: "p2", name: "Mind Armor", price: "", variant: "Top Seller", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CtJvMn9momZmpQncydBEDXlj8M/uploaded-1777876213411-e3c9sv8d.png", onProductClick: () => window.open('https://mindarmor.example.com', '_blank') },
